...
Consul and Vault will be started together in two separate, but linked containers.

Vault would be configured to use the [`consul` backend](https://www.vaultproject.io/docs/secrets/consul/).
...
All done: you have now running both Consul and Vault side by side.
